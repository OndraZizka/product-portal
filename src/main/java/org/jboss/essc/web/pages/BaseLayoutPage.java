...
public class BaseLayoutPage extends WebPage {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        response.render(CssHeaderItem.forReference(new CssResourceReference(BaseLayoutPage.class, "default.css")));
        //response.renderJavaScriptReference(new JavaScriptResourceReference( BaseLayoutPage.class, "common.js" ));
        response.render(JavaScriptHeaderItem.forReference(new JavaScriptResourceReference(BaseLayoutPage.class, "common.js")));
    }
